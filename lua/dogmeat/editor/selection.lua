...
---@field start_line integer The start line of the selection
---@field end_line integer The end line of the selection
---@field mode string The visual mode used to select the text
